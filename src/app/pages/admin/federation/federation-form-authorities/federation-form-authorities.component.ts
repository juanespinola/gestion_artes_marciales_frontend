...
@Component({
  selector: 'app-federation-form-authorities',
  standalone: true,
  imports: [
    MaterialModule,
    FormsModule,
  ...
  templateUrl: './federation-form-authorities.component.html',
  styleUrl: './federation-form-authorities.component.scss'
})
export class FederationFormAuthoritiesComponent {
